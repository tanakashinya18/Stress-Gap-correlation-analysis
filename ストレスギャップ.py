...
Original file is located at
    https://colab.research.google.com/drive/1MF0EnvBdvc-YxwEHx0NW2sOaMKhDgxVl
"""
...
impression_file = "印象味覚ギャップ.xlsx"
stress_sheet = "苦味"
impression_sheet = "苦味"
target_color = "無"
...
for color in stress_df.columns:
    ...
    # グラフを保存
    plt.savefig(f"{color}_苦味_ストレスとギャップ.png", bbox_inches="tight", dpi=300)
    plt.show()

# 相関係数の結果をCSVに保存
correlation_df = pd.DataFrame(correlation_results)
correlation_df.to_csv("相関係数_苦味_ストレスとギャップ.csv", index=False)
